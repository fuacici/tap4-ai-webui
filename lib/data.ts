...
export const dataList: WebNavigationListRow[] = [
  ...
  },
  {
    ...
    name: 'inception-ai',
    title: 'Inception AI - Portrait Generator',
    content: 'Inception AI is a free online service that uses AI technology to create beautiful portraits.',
    url: 'https://apps.apple.com/app/apple-store/id6462812178?pt=896180&ct=aitools4x.com&mt=8',
    imageUrl:
      'https://is1-ssl.mzstatic.com/image/thumb/PurpleSource122/v4/d7/de/6a/d7de6a00-1aef-5ab4-2038-bcd74be0a290/623650c4-24ed-4ff5-998a-57786a97ed0d_1_APP_IPHONE_67_1.jpg/400x800bb.png',
    thumbnailUrl: 'https://inappres.s3.eu-north-1.amazonaws.com/appstatic/web/inception-thumbnail.png',
  },
  {
...
export const detailList: WebNavigationDetailData[] = [
  ...
  },
  {
    ...
    tagName: 'Freemium',
    websiteData: 'https://apps.apple.com/app/apple-store/id6462812178?pt=896180&ct=aitools4x.com&mt=8',
    starRating: 5,
